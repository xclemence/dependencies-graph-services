...
using Dependencies.Graph.Api.StartupExtensions;
...
namespace Dependencies.Graph.Api
{
    public class Startup
    {
        ...
        public static string Version =>
            typeof(Startup).GetTypeInfo().Assembly.GetCustomAttribute<AssemblyFileVersionAttribute>().Version.Replace(".", "_", System.StringComparison.OrdinalIgnoreCase);
